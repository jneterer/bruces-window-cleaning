...
export class AppComponent {
  readonly imageContents: IImageContent[] = [
    ...
    },
    {
      ...
      title: "Screens",
      content:
        "Surprisingly, screens can collect a bunch of dirt and flies. These are cleaned to ensure your window can stay clean longer. Screens are priced at $2 per screen.",
      reversed: true,
    },
  ];
}
